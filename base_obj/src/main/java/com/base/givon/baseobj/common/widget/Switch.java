...
public class Switch extends View implements Checkable, ThemeManager.OnThemeChangedListener {
    ...
    public Switch(Context context, int styleId) {
        super(context);

        init(context, null, 0, 0, styleId);
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes, int styleId) {
    ...
    public void setmThumbColors(ColorStateList mThumbColors) {
        this.mThumbColors = mThumbColors;
        invalidate();
    }

    public void setmTrackColors(ColorStateList mTrackColors) {
        this.mTrackColors = mTrackColors;
        invalidate();
    }

    public static ColorStateList createTrackColors(int checkColor, int unCheckColor) {
        ColorStateList mTrackColors = null;
        if (mTrackColors == null) {
            int[][] states = new int[][]{
                    new int[]{-android.R.attr.state_checked},
                    new int[]{android.R.attr.state_checked},
            ...
            int[] colors = new int[]{
//                    ColorUtil.getColor(ThemeUtil.colorControlNormal(context, checkColor), 0.5f),
//                    ColorUtil.getColor(ThemeUtil.colorControlActivated(context, unCheckColor), 0.5f),
                    unCheckColor, checkColor,
            };
    ...
    public static ColorStateList createThumbColors(int checkColor, int unCheckColor) {
        ColorStateList mThumbColors = null;
        if (mThumbColors == null) {
            int[][] states = new int[][]{
                    new int[]{-android.R.attr.state_checked},
                    new int[]{android.R.attr.state_checked},
            ...
            int[] colors = new int[]{
                    unCheckColor, checkColor,
//                    ThemeUtil.colorControlActivated(context, checkColor,),
            };
    ...
    protected void onAttachedToWindow() {
        ...
        if (mStyleId != 0 && null != ThemeManager.getInstance()) {
            try {
