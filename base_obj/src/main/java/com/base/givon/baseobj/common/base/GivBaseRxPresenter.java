 ...
 */
public class GivBaseRxPresenter<View> extends RxPresenter<View> {
    @Override
    ...
    public <T> void startOnce(final Func0<Observable<T>> observableFactory,
        ...
        observableFactory.call().compose(GivBaseRxPresenter.this.<T>deliverFirst()).subscribe(split(onNext, onError));
    }
