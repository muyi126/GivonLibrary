package com.base.givon.givonlibrary.ui.orderList;
...
import com.base.givon.givonlibrary.common.widget.SelectDateDialog;
...
//                });
    ...
    public void onClickEdit() {
        if (null == mSelectDateDialog) {
            mSelectDateDialog = new SelectDateDialog(this, R.style.selectorDialog);
            mSelectDateDialog.setOnSelectDateListener(new SelectDateDialog.OnSelectDateListener() {
