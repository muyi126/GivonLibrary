package com.base.givon.givonlibrary.api.entity.element;
...
public class Order {
    ...
    private List<OrderTogetherPositionList> togetherPositionList;//市区中转目的地集合
    ...
    public void setTouristGroupList(List<OrderTouristGroupList> touristGroupList) {
    ...
    public void setHotelNameList(List<OrderHotelNameList> hotelNameList) {
    ...
    public void setTogetherPositionList(List<OrderTogetherPositionList> togetherPositionList) {
    ...
    public String getTogetherPositionListToString() {
        ...
        for (OrderTogetherPositionList positionList : togetherPositionList) {
