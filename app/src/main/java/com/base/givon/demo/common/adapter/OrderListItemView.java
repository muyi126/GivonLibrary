...
import com.base.givon.baseobj.common.utils.TimeUtil;
import com.base.givon.demo.R;
import com.base.givon.demo.api.entity.element.Order;
import com.base.givon.demo.api.entity.element.OrderHotelNameList;
import com.base.givon.demo.common.qualifier.ClickType;
import com.base.givon.demo.common.widget.TextDescribeBodyView;
 ...
 */
public class OrderListItemView extends com.base.givon.demo.common.base.BaseAdapterItemView<Order> {
    ...
    @Override
    public void bind(com.base.givon.demo.api.entity.element.Order order) {
        if (null != order) {
...
//            tv_time.setText("任务时间 " + StringUtil.getDefultString(order.getTaskStartTime()) + "至" + StringUtil.getDefultString(order.getPlanCompleteTime()));
    ...
    public void setViewTime(TextView view, com.base.givon.demo.api.entity.element.Order order) {
