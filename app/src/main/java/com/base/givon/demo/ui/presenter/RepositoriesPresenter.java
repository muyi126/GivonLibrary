...
import com.base.givon.demo.common.transformer.SchedulerTransformer;
import com.base.givon.demo.module.GitHubModel;
        ...
        restartableLatestCache(REQUEST_ID, new Func0<Observable<List<Repositories>>>() {
                    ...
                    public Observable<List<Repositories>> call() {
                        return mGitHubModel.getSearchRepositories(mKey, pageIndex, 20)
                                .map(new Func1<com.base.givon.demo.api.entity.RepositoriesEntity, List<Repositories>>() {
                                    @Override
                                    public List<Repositories> call(com.base.givon.demo.api.entity.RepositoriesEntity repositoriesEntity) {
